...
export default class ModeloDePerfilamientoComponent extends Component {
    constructor(props) {
        super(props)
        this.state = {
            data: null,
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    axios.delete(Global.perfilamientosModel + "/" + id, config)
                        .then(response => {
    ...
    render() {
        ...
        if (abrirEditor) {
            if(idModel){
                return <Redirect
                    to={`/modelo-de-perfilamiento/${idModel}`}
                />;
            } else {
                return <Redirect
                    to={`/modelo-de-perfilamiento/crear`}
                />;
            }
        }
        return (
            <div>
                ...
                <div className="section-content">
                    <div className="flex-input-add input-add-spacebetween">
                        <h4 className="mr-2">MODELOS DE PERFILAMIENTO</h4>
                    </div>
                    <hr />
                    <br />
                    {data &&
